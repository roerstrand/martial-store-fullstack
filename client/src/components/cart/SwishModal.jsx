...
function SwishModal({ total, onConfirm, onClose }) {
      ...
      <div className="klarna-modal klarna-modal--swish" onClick={(e) => e.stopPropagation()}>
        ...
        {step === "error" ? (
          ...
          <>
            ...
            <p className="klarna-modal__sub">You are about to pay with Swish</p>
            ...
            <p className="klarna-modal__secure">🔒 Secured by Swish · Demo mode</p>
          </>
        ) : (
          <div className="klarna-modal__processing">
