...
const products = (userId) => [
  ...
  { user_id: userId, title: "Women's Boxing Startkit", price: 29, description: "Complete boxing starter kit for women.", image: "womens_boxing_startkit.jpg", category: "boxing", rating: 4, sale: 20, sold: 89, isLimitedSale: true },
  { user_id: userId, title: "Shin Guards", price: 39, description: "Protective shin guards for Muay Thai and kickboxing.", image: "shin_guards.jpg", category: "muaythai", rating: 5, sale: 15, sold: 341, isLimitedSale: true },
  { user_id: userId, title: "Boxing Bag", price: 199, description: "Heavy duty boxing bag for intense training sessions.", image: "boxing_bag.jpg", category: "boxing", rating: 5, sale: 0, sold: 157, isNewArrival: true },
  { user_id: userId, title: "Black Boxing Gloves", price: 49, description: "Durable boxing gloves for training and sparring.", image: "black_boxing_gloves.jpg", category: "boxing", rating: 4, sale: 0, sold: 428 },
  { user_id: userId, title: "Boxing Helmet", price: 59, description: "Full protection boxing helmet for safe sparring.", image: "boxing_helmet.jpg", category: "boxing", rating: 4, sale: 10, sold: 112, isLimitedSale: true },
  { user_id: userId, title: "Karate Kimono", price: 69, description: "Traditional karate gi for training and grading.", image: "karate_kimono.jpg", category: "karate", rating: 4, sale: 25, sold: 76, isLimitedSale: true },
  { user_id: userId, title: "Boxing Pads", price: 44, description: "Focus pads for pad work and technique training.", image: "boxing_pads.jpg", category: "boxing", rating: 5, sale: 0, sold: 203, isNewArrival: true },
  { user_id: userId, title: "Boxing Boots", price: 89, description: "Lightweight boxing boots for speed and ankle support.", image: "boxing_boots.jpg", category: "boxing", rating: 4, sale: 30, sold: 64, isLimitedSale: true },
  { user_id: userId, title: "Snake Skin Boxing Gloves", price: 69, description: "Premium snake skin pattern boxing gloves for style and performance.", image: "margo-evardson-YYouq46SOXw-unsplash.jpg", category: "boxing", rating: 5, sale: 0, sold: 318, isNewArrival: true },
  { user_id: userId, title: "Blue BJJ Gi", price: 89, description: "Competition-grade blue BJJ gi with reinforced stitching.", image: "BJJ_GI_blue.jpg", category: "bjj", rating: 5, sale: 0, sold: 145, isNewArrival: true },
  { user_id: userId, title: "BJJ Rashguard", price: 39, description: "Compression rashguard for no-gi training and competition.", image: "BJJ_rashguard.jpg", category: "bjj", rating: 4, sale: 10, sold: 267, isLimitedSale: true },
  { user_id: userId, title: "No-Gi Shorts", price: 34, description: "Lightweight grappling shorts for no-gi BJJ and submission wrestling.", image: "BJJ_nogishorts.jpg", category: "bjj", rating: 4, sale: 0, sold: 193, isNewArrival: true },
  { user_id: userId, title: "Muay Thai Shorts", price: 29, description: "Traditional Muay Thai shorts with wide cut for full kicking range.", image: "muay_thai_shorts.jpg", category: "muaythai", rating: 4, sale: 15, sold: 381, isLimitedSale: true },
  { user_id: userId, title: "Ankle Guards", price: 19, description: "Elastic ankle supports for Muay Thai and kickboxing training.", image: "muay_thai_ancle_guards.jpg", category: "muaythai", rating: 4, sale: 0, sold: 156 },
  { user_id: userId, title: "Karate Belt", price: 12, description: "Traditional cotton karate belt available in all grades.", image: "karate_belt.jpg", category: "karate", rating: 4, sale: 0, sold: 92 },
  { user_id: userId, title: "Karate Helmet", price: 49, description: "Full-face karate helmet for safe kumite sparring.", image: "karate_helmet.jpg", category: "karate", rating: 4, sale: 20, sold: 48 },
  { user_id: userId, title: "Muay Thai Pads", price: 54, description: "Thai pads for partner drills — built to absorb heavy kicks and elbows.", image: "muaythai_pads.jpg", category: "muaythai", rating: 5, sale: 0, sold: 127, isNewArrival: true },
  {
    user_id: userId,
    title: "Karate Chest Pads",
    price: 44,
    description:
      "Lightweight chest protector approved for WKF kumite competition.",
...
const articles = [
  {
    ...
    excerpt:
      "A personal journey through years of dedication, sweat, and perseverance on the mats.",
  ...
  },
  {
    ...
    excerpt:
      "Breaking down the mechanics behind converting sweeps into dominant positions and submissions.",
  ...
  },
  {
    ...
    excerpt:
      "Unpacking the geometry and timing behind one of grappling's most effective submissions.",
    ...
    author: "Jon Doe",
    image: "triangle_choke.jpg",
    category: "bjj",
  },
  {
    title: "Why the Jab Wins Fights",
    excerpt:
      "The most underrated punch in boxing is also the most important. Here is why elite fighters live and die by it.",
    ...
    author: "Marcus Reid",
    image: "jab_wins_fight.jpg",
    category: "boxing",
  },
  {
    title: "Muay Thai: The Art of Eight Limbs",
    excerpt:
      "How Thailand's national sport became the world's most complete striking system — and why it belongs in every fighter's toolkit.",
    ...
    image: "muay_thay_art_eight_limbs.jpg",
    category: "muaythai",
  },
  {
    title: "Sparring Smart: How to Get Better Without Getting Hurt",
    excerpt:
      "The fighters who last longest in Muay Thai are the ones who learn to spar with their head, not just their body.",
    ...
    author: "Saenchai",
    image: "sparring_smart.jpg",
    category: "muaythai",
  },
  {
    title: "Kata: The Living Encyclopedia of Karate",
    excerpt:
      "Kata is far more than choreography. It is a compressed archive of combat knowledge passed down through centuries.",
    ...
    image: "kata_encyclopedia.jpg",
    category: "karate",
  },
  {
    title: "How My Role Models Inspired Me",
    excerpt:
      "The fighters and coaches who shaped my mindset and pushed me to become the athlete I am today.",
